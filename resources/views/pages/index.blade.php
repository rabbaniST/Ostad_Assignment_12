            ...
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark my-1"><span data-plugin="counterup">{{ $soldTicket }}</span></h3>
            ...
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark my-1"><span data-plugin="counterup">{{ $availableSeats }}</span></h3>
                                <p class="text-muted mb-0 text-truncate">Available Seats</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-end">
                                <h3 class="text-dark my-1"><span data-plugin="counterup">{{ $location }}</span></h3>
                                <p class="text-muted mb-0 text-truncate">Location</p>
                            </div>
                        </div>
                    </div>
                </div>
